...
export const LOCALES: LocaleEntry[] = [
	...
	{ code: "bm_Latn", name: "Bambara (Latin)" },
	{ code: "bm_Latn_ML", name: "Bambara (Latin Mali)" },
	...
	{ code: "en_CC", name: "English (Cocos Islands)" },
	...
	{ code: "en_CZ", name: "English (Czech Republic)" },
	...
	{ code: "fr_BL", name: "French (St. Barthelemy)" },
	...
	{ code: "fr_CI", name: "French (Cote d Ivoire)" },
	...
	{ code: "fr_RE", name: "French (Reunion)" },
	...
	{ code: "iu_Cans", name: "Inuktitut (Canadian Syllabics)" },
	{ code: "iu_Cans_CA", name: "Inuktitut (Canadian Syllabics Canada)" },
	...
	{ code: "ks_Arab", name: "Kashmiri (Arabic)" },
	{ code: "ks_Arab_IN", name: "Kashmiri (Arabic India)" },
	...
	{ code: "ky", name: "Kyrgyz" },
	{ code: "ky_Cyrl", name: "Kyrgyz (Cyrillic)" },
	{ code: "ky_Cyrl_KG", name: "Kyrgyz (Cyrillic Kyrgyzstan)" },
	{ code: "lag", name: "Langi" },
	...
	{ code: "mgo", name: "Meta" },
	{ code: "mgo_CM", name: "Meta (Cameroon)" },
	{ code: "mk", name: "Macedonian" },
	{ code: "mk_MK", name: "Macedonian (Macedonia)" },
	{ code: "ml", name: "Malayalam" },
	{ code: "ml_IN", name: "Malayalam (India)" },
	{ code: "mn", name: "Mongolian" },
	{ code: "mn_Cyrl", name: "Mongolian (Cyrillic)" },
	{ code: "mn_Cyrl_MN", name: "Mongolian (Cyrillic Mongolia)" },
	...
	{ code: "ms_Latn", name: "Malay (Latin)" },
	{ code: "ms_Latn_BN", name: "Malay (Latin Brunei)" },
	{ code: "ms_Latn_MY", name: "Malay (Latin Malaysia)" },
	{ code: "ms_Latn_SG", name: "Malay (Latin Singapore)" },
	...
	{ code: "nb_NO", name: "Norwegian Bokmal (Norway)" },
	{ code: "nb_SJ", name: "Norwegian Bokmal (Svalbard Jan Mayen)" },
	...
	{ code: "pt_ST", name: "Portuguese (Sao Tome Principe)" },
	...
	{ code: "sv_AX", name: "Swedish (Aland Islands)" },
	...
	{ code: "tg", name: "Tajik" },
	{ code: "tg_Cyrl", name: "Tajik (Cyrillic)" },
	{ code: "tg_Cyrl_TJ", name: "Tajik (Cyrillic Tajikistan)" },
	{ code: "th", name: "Thai" },
	...
	{ code: "tk_Latn", name: "Turkmen (Latin)" },
	{ code: "tk_Latn_TM", name: "Turkmen (Latin Turkmenistan)" },
	{ code: "to", name: "Tongan" },
	...
	{ code: "tzm_Latn", name: "Central Atlas Tamazight (Latin)" },
	{ code: "tzm_Latn_MA", name: "Central Atlas Tamazight (Latin Morocco)" },
	{ code: "ug", name: "Uyghur" },
	{ code: "ug_Arab", name: "Uyghur (Arabic)" },
	{ code: "ug_Arab_CN", name: "Uyghur (Arabic China)" },
