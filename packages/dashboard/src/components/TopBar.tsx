...
export default function TopBar() {
	...
	return (
		<header className="flex h-12 shrink-0 items-center justify-between border-b border-glass-border/60 bg-[oklch(0.11_0.018_265_/_0.7)] px-4 backdrop-blur-2xl backdrop-saturate-[1.3]">
